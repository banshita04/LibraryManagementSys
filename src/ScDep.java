 ...
 * @author Banshita
 */
public class ScDep extends javax.swing.JFrame {

    /**
     * Creates new form ScDep
     */
    public ScDep() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SCIENCE DEPARTMENT");

        jLabel2.setText("CHOOSE ANY BOOK: ");

        sci.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1 - M.S. Longair: Theoretical concepts in physics", "2 - Richard Feynman: The Feynman lectures on Physics (3 vols)", "3 - The New Physics edited by Paul Davies.", "4 - Kiran Gupta: Classical Mechanics of Particles and Rigid Bodies ", "5 - Lorrain & Corson: Electromagnetism, Principles and Applications" }));
    ...
    private void subActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_subActionPerformed
        ...
        sub.setText(sci.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScDep.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
